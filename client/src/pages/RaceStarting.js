  ...
  return (
    <div className="mt-64 flex-col lg:flex-row justify-center flex h-[25vh] gap-12 px-12">
      ...
      <div className="h-auto lg:h-[30vh] flex flex-col w-[80] gap-10">
        <div className="bg-overlay text-md w-8rem h-[6vh] rounded-2xl px-8 flex items-center gap-10 py-1">
          <p className='text-accentText mr-10'>difficulty</p>
          <button onClick={() => setDifficulty('easy')} className="text-accentText hover:text-accent">easy</button>
          <button onClick={() => setDifficulty('medium')} className="text-accentText hover:text-accent">medium</button>
          <button onClick={() => setDifficulty('hard')} className="text-accentText hover:text-accent">hard</button>
        </div>
        <div className="bg-overlay mb-6 text-md w-8rem h-[6vh] rounded-2xl px-8 flex items-center gap-10 py-1">
          <p className='text-accentText mr-24'>words</p>
          <button className="text-accentText hover:text-accent mr-6">15</button>
          <button className="text-accentText hover:text-accent mr-6">30</button>
          <button className="text-accentText hover:text-accent">60</button>
        </div>
        <div className="bg-accent text-md w-8rem h-[6vh] rounded-2xl px-8 flex items-center justify-center gap-10 py-1">
          <button onClick={startRace} className="text-background font-bold hover:overlay">
            start race!
          </button>
        </div>
      </div>
